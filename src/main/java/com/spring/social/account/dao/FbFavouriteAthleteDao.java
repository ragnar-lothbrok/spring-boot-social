...
@Repository
public interface FbFavouriteAthleteDao extends CrudRepository<FbFavouriteAthlete, Long> {

	@Modifying
	@Transactional
	@Query("DELETE FROM FbFavouriteAthlete WHERE userFaceBookId = :userFacebookId ")
